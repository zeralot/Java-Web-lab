                    ...
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper guest-book">
                                <div class="controls">
                                    <button  type="button"><a href="SendRegards.jsp">Add a message - Click here!</a></button>
                                </div>
                                <div class="heading">
                                ...
                                <div class="content">
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            ...
                                            <div class="item">
                                                <div class="controls">
                                                    <a rel="nofollow" class="email" href="mailto:<%=rs.getString(3)%>">Email</a>
                                                    <span class="date-text"><%=rs.getString(6)%></span>
                                                </div>
                                                <div class="heading">
