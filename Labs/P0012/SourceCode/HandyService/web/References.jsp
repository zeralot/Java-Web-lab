...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:url" content="http://us-123handyman.simplesite.com/422327265">
        <meta property="og:title" content="References">
        <meta property="og:description" content="haipt@fpt.edu.vn - I love your service - 07-04-2016 - asd - asdasd - 07-04-2016">
        <meta property="og:updated_time" content="2016-06-23T10:43:56.9002970+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Prototype/References - us-123handyman.simplesite.com_files/9768477.design.v27169.css">
        <link rel="canonical" href="http://us-123handyman.simplesite.com/422327265">
    ...
    <body data-pid="422327265" data-iid="">
                    ...
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper guest-book">
                                <div class="controls">
                                    <button class="btn" type="button"><a href="Send.jsp">Add a message - Click here!</a></button>
                                </div>
                                <div class="heading">
                                ...
                                <div class="content">
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            ...
                                            <div class="item">
                                                <div class="controls">
                                                    <a rel="nofollow" class="email" href="mailto:<%=rs.getString(4)%>">Email</a>
                                                    <a rel="nofollow" class="website" href="<%=rs.getString(3)%>" target="_blank">Website</a>
                                                    <span class="date-text"><%=rs.getDate(6)%></span>
                                                </div>
                                                <div class="heading">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="img-simple span4 pull-left">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal" data-href="<%=rs.getString(5)%>"><img src="<%=rs.getString(5)%>"></a>
                                                        </div>
                                                    </div> <% }%>
                                                    <p><%=rs.getString(2)%></p>
                                                </div>
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content"><span><ul>
                                                <li><a id="share-facebook" href="http://us-123handyman.simplesite.com/422327265#"><i class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
                                                <li><a id="share-twitter" href="http://us-123handyman.simplesite.com/422327265#"><i class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
                                                <li><a id="share-google-plus" href="http://us-123handyman.simplesite.com/422327265#"><i class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>    
                                            </ul></span></div>
                                </div>
                                <div class="wrapper viral-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom">
                                            <a rel="nofollow" href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3arightbanner&amp;referercustomerid=15830917&amp;refererpageid=422327265" class="btn btn-block">Try it for FREE now</a>
                                        </div>
