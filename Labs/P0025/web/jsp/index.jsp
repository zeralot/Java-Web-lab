<%-- 
    Document   : index
    Created on : Jul 16, 2017, 10:19:44 AM
    Author     : anhgqse04763
--%>
...
<html lang="en-US" class="">
    <head>
        ...
        <link rel="canonical" href="http://us-123-education.simplesite.com/">
    ...
    <body data-pid="423611837" data-iid="">
                                        ...
                                        <div class="content">
                                            <dl class="dl-horizontal">
                                                <c:forEach var="item" items="${courses}">
                                                    <dt><span class="date-text">${item.date}</span></dt>
                                                    <dd>
                                                        <h4>
                                                            <a rel="nofollow" href="#">${item.title}</a>
                                                        </h4>
        ...
        <input type="hidden" id="anti-forgery-token" value="">

        <div id="sm2-container" class="movieContainer high_performance  high_performance" style="z-index: 10000; position: fixed; width: 8px; height: 8px; bottom: 0px; left: 0px; overflow: hidden; visibility: hidden;">
