<%-- 
    Document   : contact
    Created on : Jul 17, 2017, 10:23:26 AM
    Author     : anhgqse04763
--%>
...
<html lang="en-US" class="">
    <head>
        ...
        <link rel="canonical" href="http://us-123-education.simplesite.com/423611839">
        ...
        <script type="text/javascript" src="./js/FrontendAppLocalePage.aspx"></script>
    </head>

    <body data-pid="423611839" data-iid="">
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <div class="span12 contact-text">
                                                <h4>CC Computer Courses</h4>
                                                <div class="heading"> 
                                                    <h4 class="item-title map-page-title">
                                                        <span style="font-size: 16px;">Address: ${info.address}</span><br>
                                                        <span style="font-size: 16px;">City: ${info.city}</span><br>
                                                        <span style="font-size: 16px;">Country: ${info.country}</span>
                                                    </h4> 
                                                    <p>
                                                        <span style="font-size: 16px;">Tel: ${info.tel}</span><br>
                                                        <span style="font-size: 16px;">Email: ${info.email}</span>
                                                    </p> 
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <form action="ContactController" method="POST">
                                                <fieldset>
                                                    ...
                                                    <div class="row-fluid">
                                                        <div class="span12">
                                                            <button class="btn btn-primary pull-right" type="submit">Send - Click here</button>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </form>
        ...
        <input type="hidden" id="anti-forgery-token" value="">
