<%-- 
    Document   : OurDiary
    Created on : Sep 21, 2016, 2:16:15 PM
    Author     : Students
--%>
                                    ...
                                    <div class="section article">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="img-simple span3 pull-right">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="#"><img src="<%= rs.getString(4) %>"></a>
                                                </div>
                                            </div>
                                            <%
                                                }
                                            %>
                                            <p><span><%= rs.getString(3) %></span></p>    
                                        </div>
                                    </div>
                                    <%
                                        }
