...
<html>
    ...
    <body>
        <div class="content">
            <div class="gioithieu">  
                <p><span style="padding-top: 10px;padding-left: 30px;font-size: 20px;font-family: Arial;">User</span></p>
        ...
        %>
        <div class="i"> <a href="#" visited="black">All(<%=h%>)  <span> |</span></a>
        ...
        <div class="bang" > 
            ...
            <div class="tren">
                ...
                <a class="title1" href="#">Username</a>   
                <a class="title" href="#">Name</a>  <a class="title2" href="#">Email</a> 
